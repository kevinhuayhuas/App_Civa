...
<!--login-box-msg-->
    ...
    <form action="../ajax/Logincontroller.php" method="post">
      <div class="form-group has-feedback">
        <input type="text" name="user" id="user" class="form-control" placeholder="Login" required="required">
    ...
    <div><br><center>
            <center><p><b>Forma parte de Civa</b><a href="formulario_registro.php"> Registrate aquí</a></p></center><?php
